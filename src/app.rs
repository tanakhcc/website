        ...
        <header class="sticky top-0 z-50 w-screen bg-sand-100">
            <nav class="relative h-14 py-2 border-b border-sand-800">
                <ul>
                    ...
                    <div class="absolute right-2 flex mt-1">
                        <li>
                            <a
                        ...
                        <li>
                            <a
                                class="m-1 rounded-lg border-4 bg-sand-700 p-1 text-xl font-semibold text-sand-100 hover:border-sand-800 hover:bg-sand-100 hover:text-sand-800 focus:border-sand-800 focus:bg-sand-100 focus:text-sand-800"
                                href="/get-involved"
                            >
                                Support TanakhCC
                            </a>
...
pub fn Footer() -> impl IntoView {
    view! {
        <footer class="bg-sand-100 border-t border-sand-800 h-12 p-2">
            <ul class="flex justify-end max-w-[83rem]">
                <li>
        ...
        <div id="hero">
            <div id="image-wrapper" class="bg-white">
                <img
                    ...
                    src="https://critic.tanakhcc.org/static/images/Babylonicus%20Petropolitanus/Babylonicus_Petropolitanus-001/heroimage.webp"
                    alt="the-hero-image"
                    width="1920px"
                    height="665px"
                />
